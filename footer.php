...
<footer role="contentinfo">
    ...
    <div class="footer-2">
      	<div class="copyright container">
            ...
            <?php if( get_theme_mod( 'vw_hotel_hide_show_scroll',true) != '') { ?>
                <?php $theme_lay = get_theme_mod( 'vw_hotel_scroll_top_alignment','Right');
                    if($theme_lay == 'Left'){ ?>
                    <a href="#" class="scrollup left"><i class="fas fa-long-arrow-alt-up"></i><span class="screen-reader-text"><?php esc_html_e( 'Scroll Up', 'vw-hotel' ); ?></span></a>
                <?php }else if($theme_lay == 'Center'){ ?>
                    <a href="#" class="scrollup center"><i class="fas fa-long-arrow-alt-up"></i><span class="screen-reader-text"><?php esc_html_e( 'Scroll Up', 'vw-hotel' ); ?></span></a>
                <?php }else{ ?>
                    <a href="#" class="scrollup"><i class="fas fa-long-arrow-alt-up"></i><span class="screen-reader-text"><?php esc_html_e( 'Scroll Up', 'vw-hotel' ); ?></span></a>
                <?php }?>
            <?php }?>
      	</div>
      	<div class="clear"></div>
