...
if ( ! class_exists( 'VW_Hotel_Content_Creation' ) ) :

	/**
	 * VW_Hotel_Content_Creation class.
	 */
	class VW_Hotel_Content_Creation extends WP_Customize_Control {
		...
		/**
		 * VW_Hotel_Content_Creation constructor.
		 *
		...
		public function __construct( WP_Customize_Manager $manager, $id, array $args ) {
			$this->button_text;
			$manager->register_control_type( 'VW_Hotel_Content_Creation' );
