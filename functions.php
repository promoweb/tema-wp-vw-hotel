...
function vw_hotel_activation_notice() {
	...
	echo '<h3>'. esc_html__( 'Warm Greetings to you!!', 'vw-hotel' ) .'</h3>';
...
function vw_hotel_scripts() {
	...
	wp_enqueue_script( 'vw-hotel-custom-scripts-jquery', get_template_directory_uri() . '/js/custom.js', array('jquery') );
...
function vw_hotel_ie_stylesheet(){
	wp_enqueue_style('vw-hotel-ie', get_template_directory_uri().'/css/ie.css');
	wp_style_add_data( 'vw-hotel-ie', 'conditional', 'IE' );
}
add_action('wp_enqueue_scripts','vw_hotel_ie_stylesheet');
...
//define
define('VW_HOTEL_FREE_THEME_DOC','https://vwthemesdemo.com/docs/free-vw-hotel/','vw-hotel');
define('VW_HOTEL_SUPPORT','https://wordpress.org/support/theme/vw-hotel/','vw-hotel');
define('VW_HOTEL_REVIEW','https://wordpress.org/support/theme/vw-hotel/reviews/','vw-hotel');
define('VW_HOTEL_BUY_NOW','https://www.vwthemes.com/themes/wordpress-hotel-theme/','vw-hotel');
define('VW_HOTEL_LIVE_DEMO','https://www.vwthemes.net/vw-hotel-pro/','vw-hotel');
define('VW_HOTEL_PRO_DOC','https://vwthemesdemo.com/docs/vw-hotel-pro/','vw-hotel');
define('VW_HOTEL_FAQ','https://www.vwthemes.com/faqs/','vw-hotel');
define('VW_HOTEL_CHILD_THEME','https://developer.wordpress.org/themes/advanced-topics/child-themes/','vw-hotel');
define('VW_HOTEL_CONTACT','https://www.vwthemes.com/contact/','vw-hotel');
define('VW_HOTEL_CREDIT','https://www.vwthemes.com/themes/free-wordpress-hotel-theme/','vw-hotel');
if ( ! function_exists( 'vw_hotel_credit' ) ) {
	function vw_hotel_credit(){
		echo "<a href=".esc_url(VW_HOTEL_CREDIT).">".esc_html__('Hotel WordPress Theme','vw-hotel')."</a>";
	}
}
